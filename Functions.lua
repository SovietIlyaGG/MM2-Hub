-- Functions Module | SovietIlyaGG | Full Mobile
return {
    _flySpeed = 20,
    _aimbotFOV = 150,
    _aimbotSmooth = 2,
    ...
    SetFlySpeed = function(self, speed) self._flySpeed = speed end,
    ...
    ToggleRapidFire = function(self, state) self._rapidFire = state end,
    ToggleInfiniteAmmo = function(self, state) self._infiniteAmmo = state end,
    ...
    FakeCrash = function(self)
        local msg = Instance.new("Message")
        msg.Text = "SERVER CRASH IN 3...2...1..."
        msg.Parent = workspace
        wait(3)
        msg.Text = "JOKE! Script by SovietIlyaGG"
        wait(3)
        msg:Destroy()
    end,
